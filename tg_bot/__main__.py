...
TECHNO_IMG = "https://telegra.ph/file/cc78f05a27489d84bfcf0.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/GODHarsh_xD")],
                                                                                   [InlineKeyboardButton(text="ADD MAFIA MUNDES TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Yuss, MAFIA BOYS Already ONline")
